## Этот проект является ответом на 3 лекцию от Ylab, это тотже 1-st и 2-nd tasks только с Docker, tests, которые были написаны на pytest, redis и "чистым кодом"
